...
- N11.6 webhook reliability is active. The dispatcher runtime already has durable restart recovery,
  ...
  test-injected observability adapters. Bulk redrive, richer dead-letter remediation, production E2E
  validation, and target-environment observability validation remain follow-up operational
  capabilities.
