...
- N11.5 authorization and rate limits is active. API runtime composition can now wire the existing
  ...
  resolution where those aggregates carry or can safely derive an instance owner. Owner modeling for
  resources without current owner fields remains open N11.5 follow-up work.
