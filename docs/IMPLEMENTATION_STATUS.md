...
| ------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- |
| N11 - Production Hardening            | Active | N11 starts after N8/N9/N10 are complete. N11.0 reconciled the production backlog, and N11.1 added a durable WorkerJob-backed queue provider behind `QueueProviderPort`.                                                                    | N11.2 - Durable EventLog      |
...
- N11 production hardening is active. The next implementation step is durable EventLog, outbox,
  and SSE replay hardening; broader production claims remain blocked until N11 gates pass.
