...
- N11.6 webhook reliability is active. The dispatcher runtime already has durable restart recovery,
  ...
  the runtime can be composed. Bulk redrive, richer dead-letter remediation, production E2E
  validation, and concrete deployment observability wiring remain follow-up operational
  capabilities.
