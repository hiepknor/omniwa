...
- N11.5 authorization and rate limits is active. API runtime composition can now wire the existing
  ...
  message-send, admin, and event-stream traffic. Distributed rate limiting, persistent ownership
  resolution, persistent security-audit evidence, and metrics export remain open N11.5 follow-up work.
