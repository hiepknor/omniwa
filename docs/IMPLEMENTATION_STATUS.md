...
| Webhooks / Events / Realtime                                                                     | Frozen                      | Durable EventLog/replay and webhook dispatcher reliability foundations present                                               | Webhook dispatcher runtime, durable JSON EventLog/outbox, SSE read surfaces, restart replay tests, safe provider signal ingestion, retry/dead-letter tests, HMAC/timestamp signing, replay verification, and `FetchWebhookHttpGateway` timeout/network failure mapping.                                                                                                                                                                                                                                                                                                                                              | Production outbox consumers, selected production EventLog backend, production webhook gateway runtime wiring, backlog metrics, production scaling, and alerting need further hardening. |
...
- N11.6 webhook reliability is active. The dispatcher runtime already has durable restart recovery,
  ...
  safe timeout/network failure mapping. Production runtime wiring remains disabled until production
