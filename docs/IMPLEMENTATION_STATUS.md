...
| ------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- |
| N11 - Production Hardening            | Active | N11 starts after N8/N9/N10 are complete. The first step is reconciling production blockers with current implementation evidence, then moving to production queue durability.                                                               | N11.1 - Production Queue      |
...
- N11 production hardening is active. The next implementation step is production queue durability
  behind `QueueProviderPort`; broader production claims remain blocked until N11 gates pass.
