...
- Denied security decisions produce safe evidence; the current runtime-wired sinks are opt-in
  ...
  provides `AuditRecordRepositoryPort`. PostgreSQL AuditRecord persistence is still required before
