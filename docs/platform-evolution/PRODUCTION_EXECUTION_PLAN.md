...
| P0-12 | Partial                 | Webhook dispatcher runtime exists with durable restart recovery, retry/dead-letter tests, HMAC/timestamp signing, replay verification, metrics, audit evidence, a `FetchWebhookHttpGateway` foundation for safe timeout/network failure mapping, and opt-in local runtime fetch gateway wiring that requires a signing secret name. Production profile enablement, operational dead-letter API/read model, and final production adapter composition remain open.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
