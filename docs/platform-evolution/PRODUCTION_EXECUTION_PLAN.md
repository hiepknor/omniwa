...
- Rate limits exist by key, instance, and endpoint class; the current runtime-wired limiter is
  ...
  the concrete production Redis client adapter/dependency approved by ADR-0008 remains required
  before promotion.
