...
| P0-12 | Partial                 | Webhook dispatcher runtime exists with durable restart recovery, retry/dead-letter tests, persisted `WebhookDelivery` delivered/retrying/dead-letter status transitions, HMAC/timestamp signing, replay verification, metrics, audit evidence, a `FetchWebhookHttpGateway` foundation for safe timeout/network failure mapping, opt-in local runtime fetch gateway wiring that requires a signing secret name, public controlled webhook delivery retry for eligible pending/retrying deliveries, and public controlled redrive for eligible dead-lettered deliveries. Production profile enablement, richer dead-letter operations, and final production adapter composition remain open.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
