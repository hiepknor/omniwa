...
- Denied security decisions produce safe evidence; the current runtime-wired sinks are opt-in
  ...
  credential posture and Redis-backed rate-limit posture before the remaining production-adapter
