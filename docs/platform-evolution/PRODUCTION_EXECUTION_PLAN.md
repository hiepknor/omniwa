...
| P0-12 | Partial                 | Webhook dispatcher runtime exists with durable restart recovery, retry/dead-letter tests, HMAC/timestamp signing, replay verification, metrics, audit evidence, and a `FetchWebhookHttpGateway` foundation for safe timeout/network failure mapping. Production runtime wiring, operational dead-letter API/read model, and final production adapter composition remain open.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
