...
| N11.1 | Production queue foundation        | Replace in-memory-only queue semantics behind `QueueProviderPort`    | Done; PostgreSQL atomic reserve + durable retry visibility covered locally |
