...
| Official SDK     | PARTIAL       | Rust SDK foundation, generated operations, and resource wrappers exist                | Need typed models and real HTTP transport implementation             |
...
| Client abstraction boundary  | Rust SDK foundation exists                          | Good direction, needs real transport and typed models   |
