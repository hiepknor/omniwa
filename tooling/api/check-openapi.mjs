...
const expectedOperations = Object.freeze([
  ...
  ["post", "/v1/instances/{instanceId}/groups/refresh"],
  ...
  ["patch", "/v1/groups/{groupId}/local-state"],
  ["get", "/v1/groups/{groupId}/members"],
  ["post", "/v1/groups/{groupId}/messages/text"],
  ["post", "/v1/groups/{groupId}/members"],
  ["delete", "/v1/groups/{groupId}/members/{memberJid}"],
  ["post", "/v1/groups/{groupId}/members/{memberJid}/promote"],
  ["post", "/v1/groups/{groupId}/members/{memberJid}/demote"],
  ["post", "/v1/groups/{groupId}/invite-link/refresh"],
  ["get", "/v1/jobs"],
  ["get", "/v1/jobs/{jobId}"],
  ["get", "/v1/webhooks"],
  ["post", "/v1/webhooks"],
  ...
  ["post", "/v1/webhook-deliveries/redrive"],
