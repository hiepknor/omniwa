...
function implementedPublicEndpoints() {
  return [
    ...
    implementedEndpoint("POST", "/v1/instances/{instanceId}/messages/text"),
    implementedEndpoint("POST", "/v1/instances"),
    implementedEndpoint("DELETE", "/v1/instances/{instanceId}"),
    implementedEndpoint("GET", "/v1/messages/{messageId}"),
    implementedEndpoint("POST", "/v1/messages/{messageId}/retry"),
    implementedEndpoint("POST", "/v1/messages/{messageId}/cancel"),
    ...
    implementedEndpoint("PATCH", "/v1/groups/{groupId}"),
    implementedEndpoint("PATCH", "/v1/groups/{groupId}/local-state"),
    implementedEndpoint("POST", "/v1/groups/{groupId}/members"),
    implementedEndpoint("DELETE", "/v1/groups/{groupId}/members/{memberJid}"),
    implementedEndpoint("POST", "/v1/groups/{groupId}/members/{memberJid}/promote"),
    implementedEndpoint("POST", "/v1/groups/{groupId}/members/{memberJid}/demote"),
...
function requiredFixtureMap() {
  return {
    ...
    instanceDestroyed: "docs/api/client-contract/fixtures/instance.destroyed.json",
    ...
    messageSendQueued: "docs/api/client-contract/fixtures/message-send.queued.json",
    messageRetryQueued: "docs/api/client-contract/fixtures/message-retry.queued.json",
    messageCancelAccepted: "docs/api/client-contract/fixtures/message-cancel.accepted.json",
