...
export const repositoryAdapterPlans = Object.freeze([
  ...
  plan({
    repositoryPort: "ChatRepositoryPort",
    aggregateRoot: "Chat",
    ownerContext: "chat",
    persistenceUnit: "Chat Navigation State",
    logicalStorage: "Chat Projection Storage",
    ...
    archiveCandidate: true,
    mappingBoundary:
      "Chat navigation state, unread counters, labels, and safe direct/group JID references.",
    traceability: {
      applicationRefs: ["ListChats", "ListInstanceChats", "GetChatStatus"],
      apiResources: ["Chat"],
      productCapability: "Chat browsing",
    },
  }),
  plan({
    repositoryPort: "ContactRepositoryPort",
    aggregateRoot: "Contact",
    ownerContext: "contact",
    persistenceUnit: "Contact Directory State",
    logicalStorage: "Contact Projection Storage",
    consistency: "eventual_projection",
    allowedOperations: ["load", "save", "exists", "findByInstance", "findByStatus", "findByJid"],
    snapshotCandidate: true,
    archiveCandidate: true,
    mappingBoundary:
      "Contact directory state and redaction-ready profile references without raw provider payload.",
    traceability: {
      applicationRefs: ["ListContacts", "ListInstanceContacts", "GetContactStatus"],
      apiResources: ["Contact"],
      productCapability: "Contact browsing",
    },
  }),
  plan({
    repositoryPort: "LabelRepositoryPort",
    aggregateRoot: "Label",
    ownerContext: "label",
    persistenceUnit: "Label Organization State",
    logicalStorage: "Label Projection Storage",
    consistency: "eventual_projection",
    allowedOperations: ["load", "save", "exists", "findByInstance", "findByStatus"],
    snapshotCandidate: true,
    archiveCandidate: true,
    mappingBoundary: "User-facing organization labels without message or contact ownership.",
    traceability: {
      applicationRefs: ["ListLabels", "ListInstanceLabels", "GetLabelStatus"],
      apiResources: ["Label"],
      productCapability: "Label organization",
    },
  }),
  plan({
