...
export const applicationQueryDefinitions = [
  ...
  query("ListChats", "history", "eventual_projection", true, false),
  query("ListInstanceChats", "history", "eventual_projection", true, false),
  query("GetChatStatus", "status", "strong_owner", true, false),
  query("ListContacts", "history", "eventual_projection", true, false),
  query("ListInstanceContacts", "history", "eventual_projection", true, false),
  query("GetContactStatus", "status", "strong_owner", true, false),
  query("ListLabels", "history", "eventual_projection", true, false),
  query("ListInstanceLabels", "history", "eventual_projection", true, false),
  query("GetLabelStatus", "status", "strong_owner", true, false),
  query("ListInstanceGroups", "history", "eventual_projection", true, false),
  query("GetGroupStatus", "status", "strong_owner", true, false),
  query("ListGroupMembers", "history", "eventual_projection", true, false),
