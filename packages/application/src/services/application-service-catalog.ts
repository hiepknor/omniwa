...
export const applicationServiceDefinitions = [
  service(
    ...
    ["GetInstanceStatus", "ListInstances"],
    false,
    true,
  ),
  service(
    ...
    ["GetMessageStatus", "GetMessageDeliveryHistory", "GetMessageMetricsSnapshot"],
    false,
    true,
  ),
  service(
  ...
  service(
    ...
    ["GetWebhookStatus", "GetWebhookDeliveryHistory", "GetWebhookMetricsSnapshot"],
    false,
    true,
  ),
  service(
  ...
  service(
    ...
    ["GetWorkerJobStatus", "GetQueueMetricsSnapshot"],
    false,
    true,
  ),
  service(
  ...
  service(
    ...
    ["GetHealthStatus", "GetOperationalMetricsSnapshot", "GetActionRequiredItems"],
    false,
    true,
  ),
